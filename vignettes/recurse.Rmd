...
NOTE: Calculating recursions in polygons was previously supported utilizing the now archived rgeos package. This functionality is being temporarily disabled until it can be reimplemented. The following documentation refers to earlier versions of recurse.
