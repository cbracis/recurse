...
#' the trajectory data with four columns (the x-coordinate, the y-cordinate, the datetime, and the animal id). 
#' @param radius numeric radius to use in units of the (x,y) location data to detect recursions.
#' @param threshold a time diference (in units \code{timeunits}) to ignore excursions outside the radius. Defaults to 0.
...
#' is the spcified radius used for all the calculations. \code{tineunits} is the specified time units used to specify
#' timespans.
#' 
